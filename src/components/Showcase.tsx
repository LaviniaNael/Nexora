...
const panels = content.showcase.panels;
...
export function Showcase() {
    ...
    mm.add("(min-width: 1024px)", () => {
      ...
      panelsEl.forEach((panel, i) => {
        ...
        if (i === 0) {
          ...
          tl.set(panel, { autoAlpha: 1, y: 0, filter: "blur(0px)" }, label);
          if (media) {
            tl.set(media, { yPercent: 0, rotateX: 0, autoAlpha: 1 }, label);
          }
        } else {
          tl.fromTo(
            panel,
  ...
  return (
    <section ref={root} id="solutions" className="relative pt-22 lg:h-screen">
      <div className="container-px mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center relative z-10">
          ...
          <h2 className="mt-3 font-display text-4xl font-semibold tracking-tight sm:text-5xl">
            ...
            <span className="text-gradient-magenta">{content.showcase.titleHighlight}</span>{" "}
            {content.showcase.titleSuffix}
          </h2>
        </div>
