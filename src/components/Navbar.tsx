        ...
        <nav className="hidden items-center gap-1 md:flex">
          {links.map((l) => {
            ...
            >
              ...
              <span className={`absolute inset-x-3 bottom-1 h-px bg-gradient-to-r from-transparent via-primary-glow to-transparent transition-transform duration-300 ${
            ...
            {links.map((l) => {
              ...
              <a
                ...
                className={`rounded-md px-3 py-3 text-sm transition-colors ${
                  isActive ? "bg-white/10 text-foreground font-medium" : "text-muted-foreground hover:bg-white/5 hover:text-foreground"
                }`}
              >
                {l.label}
              </a>
